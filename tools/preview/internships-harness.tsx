/** Design harness for InternshipsPanel + CollegesPanel. Stubs the REST layer with real-shaped rows. Not shipped. */
import { createRoot } from 'react-dom/client'
import { BrowserRouter } from '@/lib/router'
import { AccessContext } from '@/lib/queries/AccessProvider'
import { ToastProvider } from '@/components/ui/Toast'
import InternshipsPanel from '@/components/member/InternshipsPanel'
import CollegesPanel from '@/components/member/CollegesPanel'
...
function embeds(table: string, r: Row): Row {
  ...
  if (table === 'interns') return { ...r, people: byId('people', r.person_id) }
...
const which = location.hash === '#colleges' ? <CollegesPanel /> : <InternshipsPanel />
